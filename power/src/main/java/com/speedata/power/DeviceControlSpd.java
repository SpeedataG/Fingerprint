...
public class DeviceControlSpd {
    ...
    private DeviceControlSpd.PowerType power_type;
     ...
     * @throws IOException
     */
    public DeviceControlSpd(DeviceControlSpd.PowerType powerType, int... gpios) throws IOException {
        this.gpios = gpios;
    ...
    public DeviceControlSpd(String powerType, int... gpios) throws IOException {
        ...
        switch (powerType) {
            case "MAIN":
                this.power_type = DeviceControlSpd.PowerType.MAIN;
                break;
            case "EXPAND":
                this.power_type = DeviceControlSpd.PowerType.EXPAND;
                break;
            case "MAIN_AND_EXPAND":
                this.power_type = DeviceControlSpd.PowerType.MAIN_AND_EXPAND;
                break;
            case "NEW_MAIN":
